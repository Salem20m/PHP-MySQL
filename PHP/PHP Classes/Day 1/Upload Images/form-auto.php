<?php
  ...
  if(isset($data) && !empty($data) && empty($data['id'])) {
    ...
    if($canInsert) {
      $stmt = $pdo->prepare("INSERT INTO auto(model, year, image, manufacturer_id) VALUES (?, ?, ?, ?)");        
      $stmt->execute([$model, $year, $file, $manufacturerID]);
                  ...
                  <div class="row">
                      <div class="col-lg-12">
                          <form role="form" method="post" enctype="multipart/form-data">
                              ...
                              <!-- Create here your new input for images -->
                              <div class="form-group">
