    ...
    <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item"><a class="nav-link active" href="{{route('events.show', $id)}}">Overview</a></li>
                </ul>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            @include('events.form', ["event" => $event, "route" => route("events.update", $id), "method"=>"PUT"])
        </main>
    </div>
</div>
